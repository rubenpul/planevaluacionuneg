    ...
    <div style="display:none;" id="div_Acciones">        
        <table width="80%">
            <tr>
                ...
                <!--<td id="td_pdf" align="right" style="display:none;">
                        <a href="#" id="a_ExportarExcel"><img title="Exportar a PDF el Plan de Evaluación" src="../imagenes/pdf.png" alt="Exportar Evaluación a PDF" height="30" width="30" id="exportarevaluacion"/></a>
                </td>-->
