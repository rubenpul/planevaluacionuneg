...
if(isset($_POST['Opcion'])){
    ...
    switch ($opcion){
        ...
        case 4: //DETALLE UNIDAD CURRICULAR
            ...
            if (isset($_POST['Carrera'])){
                ...
                $tablaexport ="<table>".
                             ...
                             "<td>Condici&oacute;n Docente</td>".
                             "<td>HAD</td>".
                             "<td>N Encuentros Verificado</td>".
                             "<td>Fechas de Encuentos Validadas</td>".
                             "<td>&Uacute;ltima Fecha Actualizaci&oacute;n</td>".
                             "</tr>";
                ...
                if ($nro > 0){	
                    ...
                    while ($i<$nro) {
                        ...
                        "<td >". strtoupper(utf8_encode(trim($datos[$i]["nombre"]))) . "</td>". 
                        "<td >".  strtoupper(utf8_encode(trim($datos[$i]["sce080d_nom_carr"]))) . "</td> ".
                        "<td >" . trim($datos[$i]["sce070d_cod_asign"]) . "</td>". 
                        "<td >".  strtoupper(utf8_encode(trim($datos[$i]["sce090d_nom_asign"]))) . "</td> ".
                        "<td >" . trim($datos[$i]["sce110d_semestre"]) . "</td>".        
                        "<td >".  trim($datos[$i]["sce070d_seccion"]) . "</td> ".
                        "<td >" . strtoupper(utf8_encode(trim($datos[$i]["desc_condicion"]))) . "</td>".        
