...
<table width="100%" border="0"  height="440" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" border="0" >
                <tr> 
                    <td height="10" valign="top" align="left" width="100%" class="barraPage"> 
                        <div align="left"><b>Reporte Registro de Evaluación Docente - CGP</b></div>
                    </td>
                </tr>
            </table>
    ...
    <fieldset>
        <legend class="txtNormalSmall">AVANCE DE REGISTRO DE EVALUACIÓN SEDES</legend>
            <label ></label>
            ...
            <div id="div_DatosSede" class="datagrid2">
              ...
              <table width=100%>
                    <tr>
                        <td align="right">
                            <label id="lbl_fechareporte" class="txtNormalSmall" ></label>
                        </td>
    ...
    <div style="display:none;" id="div_carrera" >            
     <fieldset>
        <legend class="txtNormalSmall">AVANCE DE REGISTRO DE EVALUACIÓN POR PROYECTO DE CARRERA</legend>
            <label></label>
    ...
    <font size="4"><b><label id="lbl_consulta_2"></label></b></font>   
     ...
     <fieldset>
        <legend class="txtNormalSmall">AVANCE DE REGISTRO DE EVALUACIÓN POR DOCENTE</legend>
            <label></label>
