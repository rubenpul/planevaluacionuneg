    ...
    switch ($opcion){
        ...
        case 1:
               ...
               if(isset($_POST['Cedula'])){      
                    ...
                    $lapso = Consultar_Lapso_Objecion($cedulaDocente);
        ...
        case 2:   
            ...
            if (isset($_POST['Cedula']) && isset($_POST['Carrera']) && isset($_POST['Asignatura']) && isset($_POST['Seccion']) && isset($_POST['Sede']) && isset($_POST['LapsoAcademico']) && isset($_POST['LapsoVigencia']) ){
                    ...
                    //VERIFICAR SI EL ESTATUS ES CERRADA
                    if ($estatus == 3){  //($estatus == 1 || $estatus == 2){
                        
                        //VERIFICAR EL MAXIMO DE OBJECIONES. 5 ESTUDIANTES POR ACTA
                        
                        ConsultarMaxObjecion(&$nromax,$cedulaDocente,$lapsoacademico,$sede,$carrera,$seccion,$asignatura,$lapsovigencia);
                        ...
                        if ($nromax < 5){        
                            while($i<$nro){
                                ...
                                "<td align=\"center\"><a href=\"#\"><img src=\"../imagenes/evaluacion_cerrada.png\" title=\"Evaluaci&oacute;n Cerrada CACE\" class=\"CerradaEvaluacion\" height=\"30\" width=\"30\"></a></td> " .
                            ...
                            $tabla = $tabla . "<tr  class=\"alt\">".
                            $tabla = $tabla . "<td colspan = \"9\" width=\"200px\" align=\"center\">YA SUPER&Oacute; EL N&Uacute;MERO M&Aacute;NXIMO DE OBJECIONES. SOLO SE PERMITEN OBJETAR HASTA UN M&Aacute;XIMO DE 5 ESTUDIANTES POR ACTA"  . "</td>".     
                            $tabla = $tabla . "<td style=\"display:none;\">0</td>".      
                            $tabla = $tabla . "</tr>"; 
                        }
                    }
                         ...
                         $tabla = $tabla . "<tr  class=\"alt\">".
                         $tabla = $tabla . "<td colspan = \"9\" width=\"200px\" align=\"center\">LAS ACTAS DEBEN ESTAR CERRADAS POR CACE PARA GENERAR REPORTES DE OBJECI&Oacute;N"  . "</td>".     
                         $tabla = $tabla . "<td style=\"display:none;\">0</td>".      
                         $tabla = $tabla . "</tr>"; 
        ...
        case 6:
            ...
            if (isset($_POST['DesSemestre']) && isset($_POST['DesAsignatura']) && isset($_POST['DesCarrera']) && isset($_POST['Carrera']) && isset($_POST['Asignatura']) && isset($_POST['Seccion']) && isset($_POST['Sede']) && isset($_POST['LapsoAcademico']) && isset($_POST['LapsoVigencia']) && isset($_POST['IdEval'])){
                ...
                while($i<$nro){
                    ...
                    "<td style=\"display:none;\" width='75px'><input disabled type=\"text\" name=\"cedula[]\" id=\"cedula\" maxlength=\"4\" size=\"2\" class=\"CedulaEst\" value = \"" . $datos[$i]['eval002d_cedula_est'] ."\"></input></td>" .
                    "<td style=\"display:none;\" width='75px'><input disabled type=\"text\" name=\"ideval[]\" id=\"ideval\" maxlength=\"4\" size=\"2\" class=\"ideval\" value = \"" . $ideval . "\"></input></td>" .
                    "<td width='75px'><input type=\"button\" name=\"actualizarnotacerrada[]\" id=\"actualizarnotacerrada\" maxlength=\"4\" size=\"2\" class=\"ActualizarNotaCerrada\" value = \"OBJETAR\"></input></td>" .
                    "<td width='75px'><input disabled type=\"button\" name=\"guardarnotacerrada[]\" id=\"guardarnotacerrada\" maxlength=\"4\" size=\"2\" class=\"GuardarNotaCerrada\" value = \"GUARDAR\"></input></td>" .
        ...
        case 10:
            ...
            if (isset($_POST['Carrera']) && isset($_POST['Asignatura']) && isset($_POST['Seccion']) && isset($_POST['Sede']) && isset($_POST['LapsoAcademico']) && isset($_POST['LapsoVigencia']) && isset($_POST['IdEval']) && isset($_POST['CedulaEst']) && isset($_POST['Ponderacion']) && isset($_POST['Asistencia']) && isset($_POST['FechaEvaluacion'])){
                ...
                /*if ($i==0){
                    ActualizarStatusPlanEvaluacionObjetada($_POST["IdEval"]);
                }*/    
                ...
                }while (($resp_bd = GuardarPonderacionObjetada($msg,$ideval,$cedula,$expediente,$carrera,$asignatura,$sede,$seccion,$lapsoacademico,$lapsovigencia,$poderacion,0/*definitiva*/,0 /*abandono*/,$asistio,$cedulaDocente,0/*nro de acta*/,$semana,$fecha_proceso,$fecha_proceso,$cedulaDocente,3/*estatus*/,$fechaevaluacion,$justificacion)) != "");

                GetNotaDefinitivaObjetada($cedula,$cedulaDocente,$carrera,$asignatura,$sede,$seccion,$lapsoacademico,$lapsovigencia,$idproductosdef);
                                 ...
                                 "<tbody>".
                                    "<thead>".
                                       "<tr>".
                                            ...
                                            "<th width=\"75px\" align=\"center\"><div class=\"tooltip\">" . utf8_encode("ACUMULADO EN NÚMERO") . "</th>".
