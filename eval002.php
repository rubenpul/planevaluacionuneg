...
<table width="100%" border="0"  height="440" cellpadding="0" cellspacing="0">
    ...
    <fieldset>
        <legend class="txtNormalSmall">OFERTA DOCENTE</legend>
            <label></label>
            <div style="display:none;" id = "div_lapso" align="right">
                ...
                <table id="table_ofertadocente">
                           ...
                           <thead>
                               <!---->
                                ...
                                <th style="display:none;" align=\"center\" >descripcion</th>
                                </tr>
                           </thead> 
                           </tbody>  
                     </table>   
                 ...
                 <table style="display:none;"  id="table_detalleasistencia" >
                            <thead>
                               ...
                               <tr>
                                    ...
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro1" id="txt_fechaencuentro1" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro1" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro1Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro2" id="txt_fechaencuentro2" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro2" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro2Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro3" id="txt_fechaencuentro3" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro3" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro3Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro4" id="txt_fechaencuentro4" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro4" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro4Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro5" id="txt_fechaencuentro5" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro5" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro5Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro6" id="txt_fechaencuentro6" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro6" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro6Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro7" id="txt_fechaencuentro7" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro7" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro7Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro8" id="txt_fechaencuentro8" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro8" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro8Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro9" id="txt_fechaencuentro9" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro9" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro9Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro10" id="txt_fechaencuentro10" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro10" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro10Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro11" id="txt_fechaencuentro11" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro11" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro11Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro12" id="txt_fechaencuentro12" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro12" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro12Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro13" id="txt_fechaencuentro13" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro13" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro13Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro14" id="txt_fechaencuentro14" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro14" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro14Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro15" id="txt_fechaencuentro15" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro15" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro15Asig" title="Asistencias Asignadas" height="30" width="30"></th>
                                    <th width="35px" align="center"><input hidden name="txt_fechaencuentro16" id="txt_fechaencuentro16" type="date"></input><a href="#"><img src="../imagenes/asignarfecha.png" id = "img_Encuentro16" title="Por Asignar Asistencias" height="30" width="30"><img style="display:none;" src="../imagenes/fechaasignada.png" id = "img_Encuentro16Asig" title="Asistencias Asignadas" height="30" width="30"></th>
