...
$(document).ready(function () {
    ...
    $("#td_pdf").click(function(){
        reset();
        alertify.alert("UNDER CONSTRUCTION...");
    ...
    $("#bot_buscardocente").click(function(){
       ...
       $("#div_DatosDocente").css("display", "block"); 
           ...
           if ($("#txt_docente").val() != ""){
               $("#lbl_ceduladocente").text($("#txt_docente").val());     
                //DATOS DOCENTE LAPSO ACTIVO
                  $.ajax({
                      ...
                      datatype: 'json',
                      type: 'POST',
                      url: 'eval014Dao.php?'+ Sesion,
                      data:{Cedula:$("#lbl_ceduladocente").text(),Opcion:16}
            ...
            reset();
            alertify.alert("INTRODUZCA EL NRO DE CÉDULA DEL DOCENTE A CONSULTAR");
            return false;   
                ...
                if (acumulado > 0 && acumulado <= 100){ //si el acumulado de evaluacion es menor al 100% se procede a almacenar en la bd
                        ...
                        success: function(data){
                            ...
                            if (data != 0){
                                ...
                                reset();
                                alertify.alert("EVALUACIÓN ACTUALIZADA SATISFACTORIAMENTE");
                    ...
                    $("#preloader").css("display", "none");
                    alertify.alert("REVISAR PONDERACIÓNES DEL PLAN DE EVALUACIÓN.");
    ...
    $("#table_planevaluacion").on('click', '.BorrarEvaluacionBase', function () {
        ...
        if (ideva > 0){
            ...
            confirmar = confirm("ESTÁ SEGURO BORRAR LA EVALUACIÓN?");
            ...
            if (confirmar){
                ...
                $.ajax({
                    ...
                    data:{Opcion:8,IdEval:ideva}
                        ...
                        if (ideva != 0){
                            $("#preloader").css("display", "none");
                            alertify.success("BORRADA EVALUACIÓN SATISFACTORIAMENTE");
                            ...
                            alertify.alert("NO SE EFECTUÓ LA ACTUALIZACIÓN");
                        }
                });
             ...
             reset();
             alertify.alert("NO SE EFECTUÓ LA ACTUALIZACIÓN. ESTA EVALUACIÓN NO ESTÁ GUARDADA EN LA BASE DE DATOS");
                ...
                $.ajax({
                    ...
                    data:{Opcion:8,IdEval:ideva}
                        ...
                        if (ideva != 0){
                            ...
                            alertify.error("NO SE EFECTUÓ LA ACTUALIZACIÓN");
                        }
    ...
    function AgregarFilasPlan(){
        ...
        clonarfila += '</td>';
        clonarfila += '<td width="80px"><a href="#"><img src="../imagenes/savedatabase.png" title="Salvar Evaluación" id="a_SalvarEvaluacion" class="GuardarEvaluacion" height="30" width="30"></a>';
        clonarfila += '<br><br><a href="#"><img src="../imagenes/eliminar.png" title="Borrar Evaluación" class="BorrarEvaluacion" height="30" width="30"></a>';
        clonarfila += '</td>';
    ...
    function AgregarFilasPlanBase(){
        ...
        clonarfila += '</td>';
        clonarfila += '<td width="80px"><a href="#"><img src="../imagenes/savedatabase.png" title="Salvar Evaluación" id="a_SalvarEvaluacion" class="GuardarEvaluacion" height="30" width="30"></a>';
        clonarfila += '<br><br><a href="#"><img src="../imagenes/eraser.png" title="Borrar Evaluación" class="BorrarEvaluacionBase" height="30" width="30"></a>';
        clonarfila += '</td>';
        clonarfila += '<td style=display:none;>';
        clonarfila += '<input name=\"idbd[]\" id=\"idbd\" maxlength=\"2\" size=\"1\"  value=\"0\"></input>';
        clonarfila += '</td>';
    ...
    $("#table_planevaluacion").on('keyup', '.EvaluarPonderacion', function () {
            ...
            if (this.value != ""){
                if (this.value < 1 || this.value >25){
                    this.value = "";
                    reset();
                    alertify.alert("LA PONDERACIÓN DE LA EVALUACIÓN ES MIN 1%- MÁX 25%");
                }
            }      
    });
    ...
    $("#table_planevaluacion").on('keyup', '.EvaluarSemana', function () {
            ...
            if (this.value != ""){
                if (this.value < 1 || this.value >16){
                    this.value = "";
                    reset();
                    alertify.alert("LA SEMANA DE LA EVALUACIÓN ES MIN 1 - MÁX 16");
                }
            }      
    });
    ...
    $("#table_planevaluacion").on('keyup', '.EvaluarProducto', function (event) {
        ...
        if (event.which != 32){
            this.value = (this.value + '').replace(/[^0-9a-zA-ZáéíóúÁÉÍÓÚñÑ.]/g, ' ');  
        }    
    ...
    function DatosLapsoPlan(codasign){
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'eval014Dao.php?'+ Sesion,
            data:{Cedula:ceduladocente,Asignatura:codasign,Opcion:9}
       ...
       if ($('#cmb_lapso').val() != '0'){
           lapsoacademico = $('#cmb_lapso').val();
            $.ajax({
                ...
                type: 'POST',
                url: 'eval014Dao.php?'+ Sesion,
                data:{Cedula:ceduladocente,LapsoAcademico:lapsoacademico,Asignatura:codasign,Opcion:10}
       ...
       if ($('#cmb_lapso').val() != '0' && $('#cmb_unidad').val() != '0'){
           ...
           codasign = $('#cmb_unidad').val();
            ...
            $.ajax({
                ...
                type: 'POST',
                url: 'eval014Dao.php?'+ Sesion,
                data:{Cedula:ceduladocente,LapsoAcademico:lapsoacademico,Asignatura:codasign,Opcion:11}
       ...
       if ($('#cmb_lapso').val() != '0' && $('#cmb_unidad').val() != '0' && $('#cmb_carrera').val() != '0'){
           ...
           ceduladocente = $("#lbl_ceduladocente").text();
            ...
            $.ajax({
                ...
                type: 'POST',
                url: 'eval014Dao.php?'+ Sesion,
                data:{Cedula:ceduladocente,LapsoAcademico:lapsoacademico,Asignatura:codasign,Carrera:codcarr,Opcion:12}
   ...
   $("#cmb_seccion").change(function(){
       ...
       if ($('#cmb_lapso').val() != '0' && $('#cmb_unidad').val() != '0' && $('#cmb_carrera').val() != '0' && $('#cmb_seccion').val() != '0'){
           ...
           ceduladocente = $("#lbl_ceduladocente").text(); 
            ...
            $.ajax({//sede
                 ...
                 type: 'POST',
                 url: 'eval014Dao.php?'+ Sesion,
                 data:{Cedula:ceduladocente,LapsoAcademico:lapsoacademico,Asignatura:codasign,Carrera:codcarr,Seccion:seccion,Opcion:13}
             ...
             $.ajax({//lapsovigencia
                 ...
                 type: 'POST',
                 url: 'eval014Dao.php?'+ Sesion,
                 data:{Cedula:ceduladocente,LapsoAcademico:lapsoacademico,Asignatura:codasign,Carrera:codcarr,Seccion:seccion,Opcion:14}
    ...
    $("#table_ofertadocente").on('click', '.GenerarPlanEvaluacion', function () {
        ...
        $(this).closest('tr').each(function(index, element){
                ...
                oferta =   $(element).find("td").eq(1).html() + " - " +  $(element).find("td").eq(11).html() + " - SECCIÓN " + $(element).find("td").eq(2).html();
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'eval014Dao.php?'+ Sesion,
            data:{Cedula:ceduladocente,Seccion:seccion,LapsoVigencia:lapsovigencia,Carrera:codcarr,Asignatura:codasign,Sede:codsede,LapsoAcademico:lapsoacademicosys,Opcion:7}
           ...
           if (str.length > 1){ // SI EXISTEN DATOS DE LA PLANIFICACION SE VISUALIZA
               ...
               $('input[name^="idbd"]').each(function() {
                    if (i < arrID.length){  
                        $(this).val(arrID[i]);
                        $('#table_planevaluacion tr').find("td").eq(0).html(arrID[i]);
	 ...
	 $("#preloader").css("display", "block");
        ...
        //if (copiar || codsedeaux != $("#lbl_codsede").text()){
           ...
           // $(this).closest('tr').each(function(index, element){
            ...
            //        oferta =   $("#cmb_carrera :selected").text() + " - " +  $("#cmb_unidad :selected").text() + " - SECCIÓN " + $("#cmb_seccion").val();
                    seccion = $("#cmb_seccion").val();
                    lapsovigencia = $("#lbl_lapsovigencia").text();
                    codcarr = $("#cmb_carrera").val();
                    codasign = $("#cmb_unidad").val();
            ...
            $.ajax({
                ...
                type: 'POST',
                url: 'eval014Dao.php?'+ Sesion,
                data:{Cedula:ceduladocente,Seccion:seccion,LapsoVigencia:lapsovigencia,Carrera:codcarr,Asignatura:codasign,Sede:codsede,LapsoAcademico:lapsoacademico,Opcion:7}
               ...
               if (str.length > 1){ // SI EXISTEN DATOS DE LA PLANIFICACION SE VISUALIZA
                   ...
                   //SI NO HAY DATOS DE PLANIFICACIÓN
