    ...
    switch ($opcion){
            ...
            if(isset($_POST['IdEval']) && isset($_POST['Cedula']) && isset($_POST['Carrera']) && isset($_POST['Asignatura']) && isset($_POST['Seccion']) && isset($_POST['Sede']) && isset($_POST['LapsoAcademico']) && isset($_POST['LapsoVigencia']) && isset($_POST['Producto']) && isset($_POST['Actividad']) && isset($_POST['Criterio']) && isset($_POST['Instrumento']) && isset($_POST['Evaluacion']) && isset($_POST['Semana'])){
                ...
                while($i<count($_POST["Producto"])){
                    ...
                    if (trim($_POST["Producto"][$i]) != "" && trim($_POST["Actividad"][$i]) != "" && trim($_POST["Criterio"][$i]) != "" && trim($_POST["Instrumento"][$i]) != "" && trim($_POST["Evaluacion"][$i]) != "" && trim($_POST["Semana"][$i]) != ""){
                        ...
                        }while (($resp_bd = GuardarEvaluacion($msg,$id_evaluacion,$sede,$carrera,$seccion,$asignatura,$lapsoacademico,$lapsovigencia,$cedulaDocente,$producto,$actividad,$criterio,$instrumento,$evaluacion,$fecha_proceso,1,$semana,$fecha_proceso,$cedulaDocente,$ideval)) != "");
        ...
        case 11:   
            ...
            if(isset($_POST["Cedula"]) && isset($_POST["LapsoAcademico"]) && isset($_POST["Asignatura"])){ 
                ...
                if (substr($_POST["Asignatura"], 0, 3) != '3000'){
                    ...
                    $combo = "<SELECT name=\"cmb_carrera\" id=\"cmb_carrera\" class=\"Combobox\">\n".
                            "<OPTION  selected value=\"11\">Seleccione...</option>\n".
                             "<OPTION  selected value=\"00\">Desarrollo Humano</option>\n";
      ...
      case 18:
            ...
            if (isset($_POST['IdProductosDef']) && isset($_POST['Carrera']) && isset($_POST['Asignatura']) && isset($_POST['Seccion']) && isset($_POST['Sede']) && isset($_POST['LapsoAcademico']) && isset($_POST['LapsoVigencia'])){
                $carrera = $_POST['Carrera']; 
                $asignatura = $_POST['Asignatura']; 
                $sede = $_POST['Sede'];
                $seccion = $_POST['Seccion'];
                ...
                if ($nroprod > 0){
                    $datos = ConsultarEstudiantesActa($nro,2,$lapsoacademico,$sede,$carrera,$seccion,$asignatura,$lapsovigencia,$idproductosdef);
                    ...
                    $tabla = "<table >".
                               ...
                               "<tr>".
                                    "<td></td>".
                                    "<td width=\"200px\">NOMBRE ESTUDIANTE</td>";
                                    $id = $i+1;
                                    while($i<$nroprod){
                                        $tabla = $tabla . "<td>" . $datosprod[$i]['eval001d_producto'] . " (" . $datosprod[$i]['eval001d_ponderacion'] . ")%</td>";
                                        $id++;
                                        $i++;   
                                    }

                                    $tabla = $tabla . "<td>NOTA ACUMULADO %</td>".
                                    "<td>" . utf8_encode("ACUMULADO EN NÚMERO") . "</td>".
                                    "<td>ACUMULADO EN LETRA</td>".                                                     
                               "</tr>";               
                    ...
                    while($i<$nro){
                        $tabla = $tabla . "<tr>".
                        "<td>" . $id . "</td>".        
                        "<td width=\"200px\">". $datos[$i]['eval002d_cedula_est'] . " " . strtoupper(utf8_encode(trim($datos[$i]['primer_apellido']))) . " " . strtoupper(utf8_encode(trim($datos[$i]['segundo_apellido']))) . ", " . strtoupper(utf8_encode(trim($datos[$i]['primer_nombre']))) . " " . strtoupper(utf8_encode(trim($datos[$i]['segundo_nombre']))) . "</td>";
                   ...
                   $datosprod = ConsultarProductosDocente($nroprod,$ceduladoc,$lapsoacademico,$sede,$carrera,$seccion,$asignatura,$lapsovigencia);
                   ...
                   while($i<$nro){
                        $tabla = $tabla . "<tr>".
                        "<td>" . $id . "</td>".        
                        "<td width=\"200px\">". $datos[$i]['sce020d_cedula'] . " " . strtoupper(utf8_encode(trim($datos[$i]['primer_apellido']))) . " " . strtoupper(utf8_encode(trim($datos[$i]['segundo_apellido']))) . ", " . strtoupper(utf8_encode(trim($datos[$i]['primer_nombre']))) . " " . strtoupper(utf8_encode(trim($datos[$i]['segundo_nombre']))) . "</td>";
