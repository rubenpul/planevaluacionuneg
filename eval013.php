...
<table width="100%" border="0"  height="440" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" border="0" >
                <tr> 
                    <td height="10" valign="top" align="left" width="100%" class="barraPage"> 
                        <div align="left"><b>Evaluación Docente</b></div>
                    </td>
                </tr>
            </table>
    ...
    <fieldset>
        <legend class="txtNormalSmall">OFERTA DOCENTE</legend>
            <label></label>
            <div id = "div_ceduladocente" align="right">
                            
                <table>
                    <tr>
                        <td>
                            <font size="2">
                            <b>Introduzca Nro de Cédula Docente</b><input type="text" name = "txt_docente" id = "txt_docente" placeholder="Escribir Cedula Docente">
                        </td>
                        <td>
                            
                            <input type="button" id = "bot_buscardocente" value = "Consultar">
                        </td>
                    </tr>
                </table> 
            ...
            <div style="display:none;" id="div_DatosDocente" class="datagrid2">
    ...
    <div style="display:none;" id="div_Reiniciar">        
        <table width="80%">
            <tr>
                <td align="right">
                    <a href="#" id="a_ReiniciarEvaluacion"><img title="Reiniciar Registro de Notas" src="../imagenes/restart.png" alt="Reiniciar Registro de Notas" height="30" width="30" id="bot_reiniciarevaluacion"/></a>
    ...
    <label style="display:none;" id="lbl_ceduladocente"></label>   
...
<table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
      <td align="left"><img src="../imagenes/restart.png" title="Reiniciar Registro de Notas de la Unidad Curricular" height="30" width="30"><b>Reiniciar Registro de Notas de la Unidad Curricular</b><br></td>
  </tr>
  <tr> 
      <td align="left"><img src="../imagenes/buscarproducto.png" title="Consultar Productos a Evaluar de la Unidad Curricular" height="30" width="30"><b>Consultar Productos a Evaluar de la Unidad Curricular</b><br></td>
  </tr>
   
  <tr> 
      <td align="left"><img src="../imagenes/agregar_evaluacion.png" title="Agregar Ponderación" height="30" width="30"><b>Agregar Ponderación al Producto o Evidencia</b><br></td>
  </tr>
  <tr> 
      <td align="left"><img src="../imagenes/evaluacion_revision.png" title="Ponderación Transcrita" height="30" width="30"><b>Ponderación Transcrita(Consultas y Actualizaciones)</b><br></td>
  </tr>
  <tr> 
      <td align="left"><img src="../imagenes/evaluacion_done.png" title="Ponderación Aprobada por el Docente" height="30" width="30"><b>Ponderación Aprobada por el Docente (Sólo Consulta y Actualizaciones Justificadas)</b><br></td>
  </tr>
  <tr> 
      <td align="left"><img src="../imagenes/evaluacion_cerrada.png" title="Ponderación Cerrada por CACE" height="30" width="30"><b>Ponderación Cerrada por CACE (Sólo Consulta)</b><br></td>
  </tr>
  <tr> 
      <td align="left"><img src="../imagenes/savedatabase.png" title="Guardar Ponderaciones de la Evaluación" height="30" width="30"><b>Guardar Ponderaciones de la Evaluación</b><br></td>
  </tr>
