...
<!-- NOMBRE: eval002.php                                                                          -->  
<!-- DESCRIPCION: Controlador de Eventos de la pagina de eval002.php. Creación de plantilla asistencia-->
<!-- ******************************************************************************************* -->*/
    ...
    $("#table_ofertadocente").on('click', '.GenerarAsistencia', function () {
        ...
        var valor;
         ...
         $(this).closest('tr').each(function(index, element){
                ...
                oferta =   $(element).find("td").eq(1).html() + " - " +  $(element).find("td").eq(14).html() + " - SECCIÓN " + $(element).find("td").eq(2).html();
